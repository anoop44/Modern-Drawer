package ss.anoop.modern.drawer
...
import ss.anoop.modern.drawer.internal.DefaultAnimationListener
import ss.anoop.modern.drawer.internal.DrawerPathGenerator
import ss.anoop.modern.drawer.internal.Orientation
import ss.anoop.modern.drawer.internal.dpToPx
import kotlin.math.abs
import kotlin.math.min

private val TAG = ModernDrawerLayout::class.java.simpleName

class ModernDrawerLayout @JvmOverloads constructor(
        context: Context,
    ...
    override fun dispatchDraw(canvas: Canvas) {
        canvas.apply {
            ...
            drawBitmap(sliderBitmap!!, bitmapStartingPoint.x, bitmapStartingPoint.y, null)
        }
    ...
    private fun initAttrs(attributeSet: AttributeSet) {
        val typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.ModernDrawerLayout)
        peekDistance = typedArray.getDimension(R.styleable.ModernDrawerLayout_peekDistance, peekDistance)
